...
public class busquedaFuncionario extends javax.swing.JFrame {
    ...
    Statement comando = con.createStatement();
     ...
     if(registro.next()==true){
       ...
       resultadoFuncionarioPublico.notas= (registro.getString("notas"));
       
         }if(privilegios == 1){
         resultadoFuncionarioPublico.propie= (registro.getString("propietario"));
       resultadoFuncionarioPublico.regis= (registro.getString("registro"));
       resultadoFuncionarioPublico.vtv="no posee permisos";
       resultadoFuncionarioPublico.seg= "no posee permisos";
       resultadoFuncionarioPublico.multas= "no posee permisos";
       resultadoFuncionarioPublico.CA= "no posee permisos";
       resultadoFuncionarioPublico.NM= "no posee permisos";
       resultadoFuncionarioPublico.NC= "no posee permisos";
       resultadoFuncionarioPublico.pedido= 0;
       resultadoFuncionarioPublico.notas= "no posee permisos";
     }
         if(privilegios==3){
       resultadoFuncionarioPublico.propie= (registro.getString("propietario"));
       resultadoFuncionarioPublico.regis= (registro.getString("registro"));
